...
\begin{itemize}
  ...
  \item Fallstudie, hier wird jede Methode, jedes Werkzeug in einem Projekt aus der Praxis getestet. dabei werden die Standardentwicklungsprozeduren der evaluierenden Organisation verwendet.
  \item Umfrage
\end{itemize}
