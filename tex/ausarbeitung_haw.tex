...
Die Wahl der Teilnehmer ist essentiell für den Erfolg eines Experiments. Bei Experimenten sollte darauf geachtet werden das die User der späteren Zielgruppe so nah wie möglich kommen. Bei Evaluationen von Visualisierungen und Interfaces also potentielle zukünftige Anwender. Im Idealfall sind dies die tatsächlichen zukünftigen Anwender, ist dies nicht möglich so sollten die Teilnehmer so nah am tatsächlichen zukünftigen User angesiedelt sein wie möglich. Das bezieht sich hauptsächlich auf die Bildung und das Alter der Teilnehmer.
